...
<Project Type="Project" LVVersion="23008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="ENUM RB_Drive Mode IND.ctl" Type="VI" URL="../../Shared Code/TypeDefs/ENUM RB_Drive Mode IND.ctl"/>
			<Item Name="Cluster_CMD_Direction Data.ctl" Type="VI" URL="../../Shared Code/TypeDefs/Cluster_CMD_Direction Data.ctl"/>
			<Item Name="Cluster_Module Velocity-Direction-Rotations.ctl" Type="VI" URL="../../Shared Code/TypeDefs/Cluster_Module Velocity-Direction-Rotations.ctl"/>
			<Item Name="Level_Velocity plus-minus 1.ctl" Type="VI" URL="../../Shared Code/TypeDefs/Level_Velocity plus-minus 1.ctl"/>
			<Item Name="Dial_Compase heading unit circle CCW positive.ctl" Type="VI" URL="../../Shared Code/TypeDefs/Dial_Compase heading unit circle CCW positive.ctl"/>
			<Item Name="ENUM RB_Feeder State.ctl" Type="VI" URL="../../Shared Code/TypeDefs/ENUM RB_Feeder State.ctl"/>
			<Item Name="NTV_Tube Wheel Positoin.vi" Type="VI" URL="../../Shared Code/NT Variables/NTV_Tube Wheel Positoin.vi"/>
			<Item Name="ENUM_Tube Wheel Positions.ctl" Type="VI" URL="../../Shared Code/TypeDefs/ENUM_Tube Wheel Positions.ctl"/>
			<Item Name="NTV_Drive On OFF.vi" Type="VI" URL="../../Shared Code/NT Variables/NTV_Drive On OFF.vi"/>
			<Item Name="NTV_Feeder State.vi" Type="VI" URL="../../Shared Code/NT Variables/NTV_Feeder State.vi"/>
			<Item Name="NTV_Drive Mode.vi" Type="VI" URL="../../Shared Code/NT Variables/NTV_Drive Mode.vi"/>
			<Item Name="NTV_Compass.vi" Type="VI" URL="../../Shared Code/NT Variables/NTV_Compass.vi"/>
			<Item Name="NTV_Drive CMD Data.vi" Type="VI" URL="../../Shared Code/NT Variables/NTV_Drive CMD Data.vi"/>
			<Item Name="NTV_Shooter Status.vi" Type="VI" URL="../../Shared Code/NT Variables/NTV_Shooter Status.vi"/>
			<Item Name="Cluster_Shooter Speed Data.ctl" Type="VI" URL="../../Shared Code/TypeDefs/Cluster_Shooter Speed Data.ctl"/>
			<Item Name="Bool_Delay OnOFF.vi" Type="VI" URL="../../Shared Code/Utility/Bool_Delay OnOFF.vi"/>
			<Item Name="Bool_Edge Detect.vi" Type="VI" URL="../../Shared Code/Utility/Bool_Edge Detect.vi"/>
			<Item Name="NTV_Max Traverse Speed.vi" Type="VI" URL="../../Shared Code/NT Variables/NTV_Max Traverse Speed.vi"/>
			<Item Name="Error Eater.vi" Type="VI" URL="../../Shared Code/Utility/Error Eater.vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC_Dashboard" Type="EXE">
				...
				<Property Name="Source[0].itemID" Type="Str">{4C2F6950-3929-4EAF-BCD5-C180D322F7F5}</Property>
