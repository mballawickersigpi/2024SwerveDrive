...
<Project Type="Project" LVVersion="20008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Dashboard Code" Type="Folder" URL="..">
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="2023-Auto_CMD.lvlib" Type="Library" URL="../../roboRIO Code/Systems/AUTO 2023/2023-Auto_CMD.lvlib"/>
			<Item Name="MotionMaster_SubCMD.lvlib" Type="Library" URL="../../roboRIO Code/Systems/MotionMaser/MotionMaster_SubCMD.lvlib"/>
			<Item Name="Sholder_ACT.lvlib" Type="Library" URL="../../roboRIO Code/Systems/Sholder/Sholder_ACT.lvlib"/>
			<Item Name="kernel32.dll" Type="Document" URL="kernel32.dll">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="File RIO_Get Team Folder.vi" Type="VI" URL="../../roboRIO Code/Utility/File RIO_Get Team Folder.vi"/>
			<Item Name="Global_STOP.vi" Type="VI" URL="../../roboRIO Code/Utility/Global_STOP.vi"/>
			<Item Name="Extend_ACT.lvlib" Type="Library" URL="../../roboRIO Code/Systems/Extention/Extend_ACT.lvlib"/>
			<Item Name="FX_Read_ Sensor Values.vi" Type="VI" URL="../../roboRIO Code/Utility/Falcon FX/FX_Read_ Sensor Values.vi"/>
			<Item Name="FX_Read_Limit Switches.vi" Type="VI" URL="../../roboRIO Code/Utility/Falcon FX/FX_Read_Limit Switches.vi"/>
			<Item Name="FX_Read_Current Values.vi" Type="VI" URL="../../roboRIO Code/Utility/Falcon FX/FX_Read_Current Values.vi"/>
			<Item Name="FX_Read_CloseLoop Values.vi" Type="VI" URL="../../roboRIO Code/Utility/Falcon FX/FX_Read_CloseLoop Values.vi"/>
			<Item Name="Error_Check for Unknow Config Name.vi" Type="VI" URL="../../roboRIO Code/Utility/Error/Error_Check for Unknow Config Name.vi"/>
			<Item Name="FX_Config_Read All.vi" Type="VI" URL="../../roboRIO Code/Utility/Falcon FX/FX_Config_Read All.vi"/>
			<Item Name="FX_Config_Read Invert.vi" Type="VI" URL="../../roboRIO Code/Utility/Falcon FX/FX_Config_Read Invert.vi"/>
			<Item Name="NiFpgaLv.dll" Type="Document" URL="NiFpgaLv.dll">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="FX_Config_Set MM Values.vi" Type="VI" URL="../../roboRIO Code/Utility/Falcon FX/FX_Config_Set MM Values.vi"/>
			<Item Name="FX_Config Set CL Values.vi" Type="VI" URL="../../roboRIO Code/Utility/Falcon FX/FX_Config Set CL Values.vi"/>
			<Item Name="FX_Config_Set Output Values.vi" Type="VI" URL="../../roboRIO Code/Utility/Falcon FX/FX_Config_Set Output Values.vi"/>
			<Item Name="FX_Config_Set Limit Travel Values.vi" Type="VI" URL="../../roboRIO Code/Utility/Falcon FX/FX_Config_Set Limit Travel Values.vi"/>
			<Item Name="Error_Handle No Set Can Value.vi" Type="VI" URL="../../roboRIO Code/Utility/Error/Error_Handle No Set Can Value.vi"/>
			<Item Name="split_error.vi" Type="VI" URL="../../roboRIO Code/Systems/SwerveDrive/Swerve config/split_error.vi"/>
			<Item Name="Wrist_ACT.lvlib" Type="Library" URL="../../roboRIO Code/Systems/Wrist/Wrist_ACT.lvlib"/>
			<Item Name="SwerveDrive_ACT.lvlib" Type="Library" URL="../../roboRIO Code/Systems/SwerveDrive/SwerveDrive_ACT.lvlib"/>
			<Item Name="NUM_Rotate Input.ctl" Type="VI" URL="../../roboRIO Code/Type Defs/NUM_Rotate Input.ctl"/>
			<Item Name="ENUM_Steer Mode Select.ctl" Type="VI" URL="../../roboRIO Code/Type Defs/ENUM_Steer Mode Select.ctl"/>
			<Item Name="DataStream_Write Data.vi" Type="VI" URL="../../roboRIO Code/Support VIs/DataStream/RT/DataStream_Write Data.vi"/>
			<Item Name="Cluster_DataStream RT Data Set.ctl" Type="VI" URL="../../roboRIO Code/Support VIs/DataStream/TypeDefs/Cluster_DataStream RT Data Set.ctl"/>
			<Item Name="DataStream_RTQ_Create.vi" Type="VI" URL="../../roboRIO Code/Support VIs/DataStream/RT/DataStream_RTQ_Create.vi"/>
			<Item Name="Cluster_Length and Width.ctl" Type="VI" URL="../../roboRIO Code/Type Defs/Cluster_Length and Width.ctl"/>
			<Item Name="Cluster_Pigeon Tilt Data.ctl" Type="VI" URL="../../roboRIO Code/Type Defs/Cluster_Pigeon Tilt Data.ctl"/>
			<Item Name="PigeonIMU_SEN.lvlib" Type="Library" URL="../../roboRIO Code/Systems/PigeonIMU/PigeonIMU_SEN.lvlib"/>
			<Item Name="Cluster_Yaw Pitch Roll in Deg.ctl" Type="VI" URL="../../roboRIO Code/Type Defs/Cluster_Yaw Pitch Roll in Deg.ctl"/>
			<Item Name="Find Smallest Circle Value.vi" Type="VI" URL="../../roboRIO Code/Utility/Find Smallest Circle Value.vi"/>
			<Item Name="PID Process Value and Error.vi" Type="VI" URL="../../roboRIO Code/Utility/PID Process Value and Error.vi"/>
			<Item Name="Swerve_Module Drive Read Config.vi" Type="VI" URL="../../roboRIO Code/Systems/SwerveDrive/Swerve config/Swerve_Module Drive Read Config.vi"/>
			<Item Name="Swerve_Module Azimuth Read Config.vi" Type="VI" URL="../../roboRIO Code/Systems/SwerveDrive/Swerve config/Swerve_Module Azimuth Read Config.vi"/>
			<Item Name="PID Process Value and Setpoint.vi" Type="VI" URL="../../roboRIO Code/Utility/PID Process Value and Setpoint.vi"/>
			<Item Name="Swerve_Module Config.vi" Type="VI" URL="../../roboRIO Code/Systems/SwerveDrive/Swerve config/Swerve_Module Config.vi"/>
			<Item Name="Swerve_Module Drive Config.vi" Type="VI" URL="../../roboRIO Code/Systems/SwerveDrive/Swerve config/Swerve_Module Drive Config.vi"/>
			<Item Name="FX_Config_Set Voltage Comp.vi" Type="VI" URL="../../roboRIO Code/Utility/Falcon FX/FX_Config_Set Voltage Comp.vi"/>
			<Item Name="Swerve_Set Status Periods.vi" Type="VI" URL="../../roboRIO Code/Systems/SwerveDrive/Swerve config/Swerve_Set Status Periods.vi"/>
			<Item Name="Swerve_Module Azimuth Config.vi" Type="VI" URL="../../roboRIO Code/Systems/SwerveDrive/Swerve config/Swerve_Module Azimuth Config.vi"/>
			<Item Name="Swerve_Module CanCoder Config.vi" Type="VI" URL="../../roboRIO Code/Systems/SwerveDrive/Swerve config/Swerve_Module CanCoder Config.vi"/>
			<Item Name="Swerve_Module CanCoder_Set Status Periods.vi" Type="VI" URL="../../roboRIO Code/Systems/SwerveDrive/Swerve config/Swerve_Module CanCoder_Set Status Periods.vi"/>
			<Item Name="Grabber_ACT.lvlib" Type="Library" URL="../../roboRIO Code/Systems/Grabber/Grabber_ACT.lvlib"/>
			<Item Name="Robot Global Data.vi" Type="VI" URL="../../roboRIO Code/Robot Global Data.vi"/>
			<Item Name="Select Positions from ENUM.vi" Type="VI" URL="../../roboRIO Code/Systems/MotionMaser/Select Positions from ENUM.vi"/>
			...
			<Item Name="Swerve_Odometry_SEN.lvlib" Type="Library" URL="../../roboRIO Code/Systems/SwerveOdometry/Swerve_Odometry_SEN.lvlib"/>
			<Item Name="lvanlys.dll" Type="Document" URL="/&lt;resource&gt;/lvanlys.dll"/>
			<Item Name="PID Process Value and Error_NONREENTRANT.vi" Type="VI" URL="../../roboRIO Code/Utility/PID Process Value and Error_NONREENTRANT.vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC_Dashboard" Type="EXE">
				...
				<Property Name="Bld_localDestDir" Type="Path">../Builds/Dashboard</Property>
				<Property Name="Bld_localDestDirType" Type="Str">relativeToCommon</Property>
				<Property Name="Bld_modifyLibraryFile" Type="Bool">true</Property>
				<Property Name="Bld_postActionVIID" Type="Ref">/My Computer/Dashboard Code/Move Dashboard/Dashboard Post-Build Action.vi</Property>
				<Property Name="Bld_previewCacheID" Type="Str">{F12754D6-B5E0-496F-B50C-3EDB6F368199}</Property>
				<Property Name="Bld_version.build" Type="Int">19</Property>
				<Property Name="Bld_version.major" Type="Int">17</Property>
				<Property Name="Bld_version.patch" Type="Int">1</Property>
				<Property Name="Destination[0].destName" Type="Str">Dashboard.exe</Property>
				<Property Name="Destination[0].path" Type="Path">../Builds/Dashboard/Dashboard.exe</Property>
				<Property Name="Destination[0].preserveHierarchy" Type="Bool">true</Property>
				<Property Name="Destination[0].type" Type="Str">App</Property>
				<Property Name="Destination[1].destName" Type="Str">Support Directory</Property>
				<Property Name="Destination[1].path" Type="Path">../Builds/Dashboard/data</Property>
				<Property Name="DestinationCount" Type="Int">2</Property>
				<Property Name="Source[0].itemID" Type="Str">{6548881F-0A57-4152-A663-C2B7EDEDE498}</Property>
